...
\lfoot{\textbf{Tema 4:} Adaptación y especialización de modelos}
\cfoot{}
\rfoot{\thepage}
...
\begin{itemize}
    ...
    \item Es obligatorio completar los dos apartados para poder participar en la evaluación final.
    \item Los resultados obtenidos y presentados deben ser producto original del trabajo de los estudiantes.
    \item Los notebook deberán contener celdas de documentación.
\end{itemize}
...
\begin{enumerate}
    ...
    Elija dos modelos distintos desde Hugging Face a los usando en los notebooks de ejemplo de la asignatura que no hayan sido especializados en la tarea.
    
    \item \textbf{Análisis de los modelos:}  
    Compare y analice ambos modelos, considerando:
    \begin{itemize}
        \item Número de parámetros, arquitectura base, licencia, peso y tamaño del modelo, técnicas de preentrenamiento utilizadas
        \item Otros parámetros de interés o destacables.
    \end{itemize}
    
    \item \textbf{Fine-tuning con LoRA:}  
    Entrene ambos modelos sobre el dataset seleccionado utilizando la técnica \textit{LoRA}.  
    Puede usar bibliotecas \texttt{PEFT} y \texttt{transformers}.
...
\begin{itemize}
    \item Un archivo \textbf{.pdf} con los dos análisis y las conclusiones.
