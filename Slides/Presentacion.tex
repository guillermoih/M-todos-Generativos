...
El objetivo es desarrollar las habilidades necesarias para poder hacer uso práctico de cualquier tipo de método generativo, entendiendo, para ello, \alert{la teoría que los sustenta}.
\end{frame}

\begin{frame}{Profesorado}
\begin{columns}[T]
\begin{column}{.49\textwidth}
\alert{\Large Guillermo Iglesias Hernández (coordinador)}
...
\begin{column}{.49\textwidth}
\centering
\alert{\Large Edgar Talavera Muñoz}
...
\begin{itemize}
    ...
    \item \alert{Prácticas}: Pruebas para poner en práctica los conocimientos adquiridos en los distintos temas de la asignatura.
\end{itemize}
\end{frame}

\begin{frame}{Criterios de calificación}
Los grupos de las \alert{prácticas} serán de \alert{5 personas}.

Para confeccionar los grupos, su composición debe seguir la siguiente distribución:
\begin{itemize}
